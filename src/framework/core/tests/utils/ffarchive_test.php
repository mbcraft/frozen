...
class TestFFArchive extends UnitTestCase
{
    ...
    function testArchiveVersion()
    {
        ...
        $version = FFArchive::getArchiveVersion($f);

        $this->assertEqual(FFArchive::CURRENT_MAJOR,$version["major"],"La major version non corrisponde!!");
        $this->assertEqual(FFArchive::CURRENT_MINOR,$version["minor"],"La minor version non corrisponde!!");
        $this->assertEqual(FFArchive::CURRENT_REV,$version["rev"],"La revision non corrisponde!!");
