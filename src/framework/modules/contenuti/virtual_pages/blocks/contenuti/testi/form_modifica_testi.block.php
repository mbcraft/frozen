...
<script type="text/javascript">
        $(function() {
                $('#textarea_testo').tinymce({
                        ...
                        theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,fgfileselect,cleanup,help,code,|,insertdate,inserttime,preview,|,forecolor,backcolor",
