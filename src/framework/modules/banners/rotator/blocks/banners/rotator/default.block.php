<?
include_block("banners/rotator/js_requires");
?>
<? if (isset($container_width) && isset($container_height)) { ?>
<div style="min-width:<?= $container_width ?>px; width:<?=$container_width ?>px;min-height: <?=$container_height ?>px; height:<?=$container_height ?>px;">
<? } ?>
<ul id="rotator_<?=$rotator_name ?>" class="generic_rotator"></ul>
<script type="text/javascript" defer="true" title="inline_script">
