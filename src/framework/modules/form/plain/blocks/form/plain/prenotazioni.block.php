...
<form name="form__commenti" method="POST" action="/actions/commenti/invia_commento.php" onsubmit="return check_comment_form();">
    ...
    <table>
        <tr>
            <td><label for="id_commenti_nome" class="form_label">Nome e cognome :*</label></td>
        ...
        <tr>
            <td><label for="id_commenti_telefono" class="form_label">Telefono :*</label></td>
            <td><input id="id_commenti_telefono" class="form_field" type="text" name="telefono" value="" size="<?=$num_cols_final ?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top"><label for="id_commenti_testo" class="form_label">Richiesta :*</label></td>
            <td><textarea style="width:100%;" class="form_field" id="id_commenti_richiesta" name="richiesta" rows="<?=$num_rows_final ?>" cols="<?=$num_cols_final - 2 ?>"></textarea></td>
        </tr>
        <tr>
