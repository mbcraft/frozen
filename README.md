...
- [x] rimuovere dipendenze dalla classe BasicObject (fatto)
...
- [x] rinominare la classe che gestisce gli archivi del framework e tutte le occorrenze (fatto - 14/Apr/2015)
- [x] migliorare la documentazione aggiungendo le traduzioni in italiano (fatto - 14/Apr/2015)
...
- [x] remove dependency from BasicObject class (done)
...
- [x] rename the class of the framework archives and all the occurrencies (done - 14/Apr/2015)
- [x] improve the documentation adding italian translations (done - 14/Apr/2015)
