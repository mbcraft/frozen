...
?>
<a href="/frozen/utils.php"><span style="padding:5px;margin:5px;border: 1px; border-style: solid;">Vai alle utilities</span></a><center><span style="font-size:20px;font-weight: bold; "><?=Host::current() ?></span></center>
